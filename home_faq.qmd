...
accordion:
  - faq:
    ...
    - header: 6. Will there be any free days during the workshop?
      body: Certainly! We recognize the need for a break. One weekend day is light/optional, and on the other day (usually Sunday), we organize an excursion to a picturesque location on Gotland. Typically, activities start at 09:00 and conclude by 17:00.
    - header: 7. Should I bring my medieval outfit?
      body: Medieval attire is strongly encouraged! We have a medieval-themed course dinner. Come as a knight, a lord, or a humble peasant — whether your style inspiration is the Witcher, Assassin's Creed, or Game of Thrones, all eras and allegiances are welcome at our table.
    ...
    - header: 12. What if I experience discrimination/harassment during the course?
      body: We follow the NBIS Training Code of Conduct. If you experience or witness harassment, discrimination, or any other inappropriate behaviour, please inform the organisers or any staff member immediately so we can act. You can review the full policy [here](home_coc.qmd).
format: html
filters:
  - accordion
---
