...
![](assets/oop_concept.webp){height="400px"}
...
![Margaret Hamilton, source: Wikimedia Commons](assets/Margaret_Hamilton_-_restoration.webp){height="500px"}

:::

::: {.column width="50%"}

![](assets/Design-Pattern-GoF-Book.webp){height="500px"}
...
:::: {.columns}
::: {.column width="50%"}
![Source: Wikimedia Commons](assets/Door_1.webp){height="400px"}
:::

::: {.column width="50%"}
![Source: Wikimedia Commons](assets/Door_5_CompressionBraceLoads-1.webp){height="400px"}
:::
::::
