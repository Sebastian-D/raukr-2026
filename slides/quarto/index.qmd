...
![](assets/literate-programming.webp){width="200px"}
...
:::: {.columns}
::: {.column width="50%"}
![](assets/rstudio-preview.webp)
:::

::: {.column width="50%"}
![](assets/vscode-preview.webp)
:::
::::
...
![](assets/demo-revealjs.webp){width="60%"}
...
![](assets/yaml-metadata-preview.webp)
...
![](https://www.r-project.org/Rlogo.webp)

![](https://www.r-project.org/Rlogo.webp){width="50%"}
```
:::
...
- Many variations
  ...
  - [![](assets/cm.webp)](https://commonmark.org/)
- Pandoc supports conversion to multiple output formats
- To compare MD variants [![](assets/bm.webp)](https://babelmark.github.io)
:::
...
![](assets/quarto-awesome.webp){height="200px" fig-align="left"}
