...
machine: how many cores it has, how fast one core is, and which package versions
are installed. Expect your own numbers to differ from those above, possibly in a
different order.
