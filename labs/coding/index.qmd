...
The example solutions for tasks 1.2 and 1.3 were written before the [R package `air`](https://posit-dev.github.io/air/editor-rstudio.html) was released. The package provides a set of functions that can help you with formatting code. Try to use `air` to reformat the code given in tasks 1.2 and 1.3 and compare with the example solutions. Are they similar?
