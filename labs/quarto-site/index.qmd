...
::: callout-note
In this tutorial, we will build a quarto blog website from scratch. It is assumed that you are in an environment with Quarto and R.

We will cover the following topics:

- Setup a quarto blog website project
- Website structure and pages
- Setting site configuration
- Setup and using GitHub for hosting

This is a preview of the [final website](https://royfrancis.github.io/site/). Refer to the official quarto documentation at <https://quarto.org> for help. 
:::
...
Initialize a repository on GitHub and copy the SSH URL.
...
<a class="btn btn-primary btn-sm" href="https://raw.githubusercontent.com/NBISweden/raukr-2026/refs/heads/main/labs/quarto-site/assets/profile.webp" role="button" target="_blank">{{< fa download >}} profile.webp</a>
...
Images can be arranged side by side in Quarto using the figure layout. Here's how you can do it:
...
<a class="btn btn-primary btn-sm" href="https://raw.githubusercontent.com/NBISweden/raukr-2026/refs/heads/main/labs/quarto-site/assets/featured.webp" role="button" target="_blank">{{< fa download >}} post-1 featured.webp</a>
...
<a class="btn btn-primary btn-sm" href="https://raw.githubusercontent.com/NBISweden/raukr-2026/refs/heads/main/labs/quarto-site/assets/patchwork/featured.webp" role="button" target="_blank">{{< fa download >}} post-2 featured.webp</a>
...
<a class="btn btn-primary btn-sm" href="https://raw.githubusercontent.com/NBISweden/raukr-2026/refs/heads/main/labs/quarto-site/assets/hero.webp" role="button" target="_blank">{{< fa download >}} hero.webp</a>
...
Commit all changes (including **docs** folder) to the repository:
