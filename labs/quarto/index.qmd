...
![This is a caption](assets/gotland.webp)
...
![This is a caption](assets/gotland.webp){width="40%"}
...
An alternative to using TeX based PDF generation is to use [Typst](https://typst.app/). Quarto supports the Typst engine natively. More information about using Typst can be found in the Quarto [typst documentation](https://quarto.org/docs/output-formats/typst.html).
...
For more project options, see [here](https://quarto.org/docs/reference/projects/options.html). To build your own personal website, see the topic **quarto-site** in the list of labs.
